...
public class DistributeRepeatingIntegers {
    ...
    public static boolean canDistribute(int[] nums, int[] quantity) {
        ...
        // Fulfill the quantities from the biggest quantity to the smallest.
    ...
    // try to fulfill the j-th order quantity
    private static boolean rec(int[] dist, int[] quantity, int j) {
